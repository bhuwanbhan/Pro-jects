...
function SignUp2() {
        ...
        <div className='bg-gradient-to-r from-slate-900 to-slate-700'>
            <div className=' mt-4 flex   items-center justify-center  h-full'>
             ...
             {/* <div className=' w-12'>
                <img src={logo} /></div> */}
                   <div className=' '>
                    <p className='items-center flex justify-center font-bold text-xl text-white'>Sign Up</p>
                  <div className=''>
                    ...
                    <div>
                      ...
                      <br />
                      <input type="text" placeholdece = 'Name' className='h-10 px-30  read-only:
                     bg-slate-300 rounded bg-amber-400' />
                    </div>
                    <div>
                      <label className='text-white'>Email Address:</label>
                      <br />
                      <input type="text" placeholder='name@ gmail.com' className='h-10 px-30
                     bg-slate-300 rounded bg-amber-400' />
                    </div>
  ...
  <label className='text-white '>Confirm Password:</label>
                      ...
                      <input type="text" placeholder='Confirm Password' className='h-10 px-30
                     bg-slate-300 rounded ' />
                ...
                <input type="checkbox"  className='' /> <span className='text-white me-38'>
                  ...
                  <button className='bg-sky-500 w-100 h-9 rounded mt-3'>Sign In </button>
                  </div>
                  </div>
               ...
               <div className='text-sky-600 ms-150 mt-2 cursor-pointer '>Sign in to an existing account</div>
            </div>
